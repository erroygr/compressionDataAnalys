...
public class FilterDataVerticalPressMPaStrategy implements FilterDataStrategy {
    ...
    public FilterDataVerticalPressMPaStrategy(ArrayList<CompressionData> arrayListCompressionData, String nameColumn,
    ...
    public ArrayList<CompressionData> goFilterData() {
        ...
        if(nameCondition=="="){
            for(int i=0;i<arrayListCompressionData.size();i++) {
                if(Double.parseDouble(nameValue)== arrayListCompressionData.get(i).getVerticalPress_MPa()){
