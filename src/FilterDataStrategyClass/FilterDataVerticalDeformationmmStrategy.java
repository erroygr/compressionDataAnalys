...
public class FilterDataVerticalDeformationmmStrategy implements FilterDataStrategy {
    ...
    public FilterDataVerticalDeformationmmStrategy(ArrayList<CompressionData> arrayListCompressionData, String nameColumn,
    ...
    public ArrayList<CompressionData> goFilterData() {
        ...
        if(nameCondition=="="){
            for(int i=0;i<arrayListCompressionData.size();i++) {
                if(Double.parseDouble(nameValue)== arrayListCompressionData.get(i).getVerticalDeformation_mm()){
