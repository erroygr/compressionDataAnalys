...
public class FilterDataStageStrategy implements FilterDataStrategy {
    ...
    public FilterDataStageStrategy(ArrayList<CompressionData> arrayListCompressionData, String nameColumn,
    ...
    public ArrayList<CompressionData> goFilterData() {
        if(nameCondition=="="){
            for(int i=0;i<arrayListCompressionData.size();i++) {
                if(nameValue.equalsIgnoreCase(arrayListCompressionData.get(i).getStage())){
