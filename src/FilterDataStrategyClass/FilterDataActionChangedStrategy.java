...
public class FilterDataActionChangedStrategy implements FilterDataStrategy {
    ...
    public FilterDataActionChangedStrategy(ArrayList<CompressionData> arrayListCompressionData, String nameColumn,
    ...
    public ArrayList<CompressionData> goFilterData() {
        if(nameCondition=="="){
            for(int i=0;i<arrayListCompressionData.size();i++) {
                if(nameValue.equalsIgnoreCase(arrayListCompressionData.get(i).getAction_Changed())){
